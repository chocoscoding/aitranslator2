  ...
  return (
    <div className="flex items-center p-4">
      <button
        ...
        className={`w-12 h-12 rounded-full border border-blue-300 flex items-center justify-center ${
          isRecording ? "bg-red-500 text-white" : ""
        }`}>
        {isRecording ? <Square className="w-4 h-4" /> : <Mic className="w-4 h-4 text-blue-400" />}
      </button>
